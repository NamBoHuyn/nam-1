...
public class Test05 {
  /*
   알파벳을 입력받아서  
  대문자이면 "입력받은 문자O는 대문자입니다."
  소문자이면 "입력받은 문자O는 소문자입니다."
  가 출력되게 하세요.
   ...
   charAt(위치값) ==> 문자열의 위치값에 들어있는 문자를 추출해주는 함수
       참고 ]
       자바에서 사용하는 위치 값은 index라고 부르며 0부터 시작한다.
   
   indwcOf(문자 또는 문자열) ==> 해당 문자가 처음 출현하는 위치값을 반환해준다.
   */
...
public static void main(String[] args) {
   ...
   int idx = str.indexOf('a');
    ...
    System.out.println("입력된 문자" + ch1 + "은" + str2 + "문자 입니다.");
